...
<body class="body">
    ...
    <div class="container fondoRegistros"><br/>
        <div class="row">
            <div class="col-md-6">
                <form action="<?= base_url()?>index.php/CRUD_MUESTRAS/" method="post">
                    <div class="form-row">
                        <div class="col-md-8">
                    ...
                    <?php foreach ($datos_Particular as $key => $i) { ?>
                        <div class="form-row">
                            <input type="text" name="rut" id="rut" value="<?= $i['RUT_PARTICULAR']?>" class="form-control" placeholder="Rut cliente" disabled>
                        </div><br/>
                        <div class="form-row">
                            <input type="text" name="nombre" id="nombre" value="<?= $i['NOMBRE_PARTICULAR']?>" class="form-control" placeholder="nombre del cliente" disabled>
                        </div>    
                    <?php } ?>
                </form>
            </div>
