...
class VALIDATE_FORM_EMPLEADO
{
    ...
    public function ValidateLargePaterno($value)
    {
        $value2=strlen($value);
        ...
        {
            return "El apellido paterno del empleado no puede estar vacio";
        }
    }

    public function ValidateLargeMaterno($value)
    {
        $value2=strlen($value);
        ...
        {
            return "El apellido materno del empleado no puede estar vacio";
        }
    }
    ...
    public function ValidateLargePass1($value)
    {
        $value2=strlen($value);
    ...
    public function ValidateLargePass2($value)
    {
        $value2=strlen($value);
        ...
        {
            return "El campo 'repita su contraseña' no puede estar vacia";
        }
    }

    public function ValidateOptionRol($value)
    {
        if($value != "0")
        {
            return "";
        ...
        {
            return "Debe seleccionar el tipo de cargo o rol del empleado";
        }
    }
