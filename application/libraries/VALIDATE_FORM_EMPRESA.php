...
class VALIDATE_FORM_EMPRESA 
{
    ...
    public function ValidateLargeNombre($value)
    {
        $value2=strlen($value);

        if($value2>2 && $value2<50)
        {
            return "";
        }else 
        {
    ...
    public function ValidateLargeDireccion($value)
    {
        $value2=strlen($value);
        ...
        {
            return "La direccion de la empresa no puede estar vacia";
        }
    }

    public function ValidateLastNumberRutContacto($value)
    {
        $value2=strtoupper(substr($value,-1));
        ...
        {
            return "el ultimo digito del rut del contacto debe ser un numero o una K ";
        }
    }

    public function ValidateNumberRutContacto($value)
    {
        $number1=strtoupper(substr($value,0,1));
        $number2=strtoupper(substr($value,1,1));
        $number3=strtoupper(substr($value,2,1));
        ...
        return "El rut del contacto ingresado no es valido";
    }

    public function ValidateLargeRutContacto($value)
    {
        $value2=strlen($value);
        ...
        {
            return "el rut del contacto debe de tener 9 digitos, no usar punto ni guíon";
        }
    }

    public function ValidateLargeCorreo($value)
    {
        $value2=strlen($value);
    ...
    public function ValidateLargeNombreContacto($value)
    {
        $value2=strlen($value);
        ...
        {
            return "El nombre del contacto no puede estar vacio";
        }
    }
}