...
class VALIDATE_FORM_PARTICULAR 
{
    ...
    public function ValidateLargeNombre($value,$min,$max)
    {
        $value2 = strlen($value);
    ...
    public function ValidateLargeDireccion($value,$min,$max)
    {
        $value2 = strlen($value);
    ...
    public function ValidateLargeTelefono2($value)
    {
        $value2 = strlen($value);

        if($value2>7 && $value2<9 || $value==0)
		{
			return "";
		}else 
		{	
